...
import static com.elena.peliculasdef.R.id.rvInfoPeli;
...
public class MainInfoPeli extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_info_peli);
        ...
        AdaptadorInfoPeli adaptador = new AdaptadorInfoPeli(peliculas);

        RecyclerView rvInfoPeli = findViewById(R.id.rvinfo);
        rvInfoPeli.setAdapter(adaptador);

        GridLayoutManager gridLayoutManager = new GridLayoutManager(this,  1);
        rvInfoPeli.setLayoutManager(gridLayoutManager);
        rvInfoPeli.addItemDecoration(new DividerItemDecoration(this, gridLayoutManager.getOrientation()));

        //action bar
        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Peliculas");
        actionBar.setSubtitle(valueOf(peliculas.size()));
        actionBar.setBackgroundDrawable((getResources().getDrawable(R.color.menu, getTheme())));
